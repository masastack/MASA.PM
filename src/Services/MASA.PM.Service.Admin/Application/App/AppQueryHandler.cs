...
namespace MASA.PM.Service.Admin.Application.Cluster
{
    public class AppQueryHandler
    {
        ...
        public async Task GetAppListAsync(AppsQuery query)
        {
            ...
            {
                List<Infrastructure.Entities.App> apps = await _appRepository.GetListByProjectIdAsync(query.ProjectIds);
                List<(EnvironmentClusterProjectApp EnvironmentClusterProjectApp,
                     int ProjectId,
                     string ClusterName,
                     string EnvName,
            ...
            {
                List<Infrastructure.Entities.App> apps = await _appRepository.GetListAsync();
