...
namespace MASA.PM.Service.Admin.Migrations
{
    ...
    [Migration("20220218054910_update_app_table")]
    partial class update_app_table
    {
            ...
            modelBuilder.Entity("MASA.PM.Service.Admin.Infrastructure.Entities.EnvironmentClusterProjectApp", b =>
                {
                    ...
                    b.HasIndex(new[] { "EnvironmentClusterProjectId", "ProjectId", "IsDeleted" }, "IX_EnvironmentClusterId_ProjectId_IsDeleted");
