...
namespace MASA.PM.Service.Admin.Migrations
{
    ...
    [Migration("20220303100717_update_project_teamid")]
    partial class update_project_teamid
    {
            ...
            modelBuilder.Entity("MASA.PM.Service.Admin.Infrastructure.Entities.EnvironmentClusterProjectApp", b =>
                {
                    ...
                    b.HasIndex(new[] { "EnvironmentClusterProjectId", "IsDeleted" }, "IX_EnvironmentClusterId_IsDeleted")
                        .HasDatabaseName("IX_EnvironmentClusterId_IsDeleted1");
