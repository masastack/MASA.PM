...
internal class EnvironmentRepository : IEnvironmentRepository
{
    ...
    public async Task<Domain.Shared.Entities.Environment> AddAsync(Domain.Shared.Entities.Environment environment)
    {
    ...
    public async Task<List<Domain.Shared.Entities.Environment>> GetListAsync()
    {
    ...
    public async Task<Domain.Shared.Entities.Environment> GetAsync(int Id)
    {
